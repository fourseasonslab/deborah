...
class DeborahDriverTwitter extends driver_1.DeborahDriver {
    /**
     * コンストラクタ。
    ...
    connect() {
        ...
        this.client.stream('user', function (stream) {
            stream.on('data', function (data) {
                ...
                if (!isMentionToMe || id == that.settings.screen_name)
                    return;
...
exports.DeborahDriverTwitter = DeborahDriverTwitter;
